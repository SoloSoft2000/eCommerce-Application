...
describe('SubmitFormButton', () => {
  it('renders with the provided value and expected classes', () => {
    const value = 'Submit'; 
    const classes = 'w-full text-center rounded bg-black p-3 text-white uppercase drop-shadow-sm hover:bg-slate-600 cursor-pointer'; 

    const { getByDisplayValue } = render(<SubmitFormButton value={value} />);
