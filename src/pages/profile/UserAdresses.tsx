      ...
      <ul>
        {user.addresses.map((address, idx) => (
          <li key={idx} className="border border-gray-200">
             <div className="p-4">
                <div className="text-sm font-semibold text-gray-700">{address.country === 'US' ? 'USA' : 'Canada'}, {address.postalCode}, {address.city}</div>
                <div className="text-sm text-gray-600 mt-1 mb-1">{address.streetName}</div>
