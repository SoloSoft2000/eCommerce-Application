...
function ButtonRemoveFromCart(props: BtnAddToCartProps): React.JSX.Element {
    ...
    return (
      <button onClick={bthRemoveClick} className='max-md:block w-1/4 max-md:w-9/12 max-md:text-xs max-md:mx-auto max-md:mb-3 text-center rounded p-3 ml-3 text-white uppercase drop-shadow-sm bg-black text-white hover:bg-slate-600 hover:text-white cursor-pointer'>
      Remove From Cart
    </button>
    );
}
