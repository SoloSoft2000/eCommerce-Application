...
function Navigation({isOpen}: NavigationProps): React.JSX.Element {
  ...
  return (
    <nav className={`flex justify-between gap-4 m-8 max-md:m-0 max-md:z-50 max-md:w-1/3 max-sm:w-2/4 max-md:h-300 max-md:bg-white 
    ...
    max-md:duration-400 max-md:ease-linear ${isOpen ? "active" : ""}`}>
      ...
      <>
        <Link className="hover:text-neutral-500 max-lg:text-sm max-md:p-3" to="/catalog">
          Catalog Product
        </Link>
        <Link className="hover:text-neutral-500 max-lg:text-sm max-md:p-3" to="/product">
          Detailed Product
        </Link>
        <Link className="hover:text-neutral-500 max-lg:text-sm max-md:p-3" to="/basket">
          <div className="flex items-center">
            <SlBasket className="mr-1" /> Basket
          </div>
        </Link>
      </>
      <Link className="hover:text-neutral-500 max-lg:text-sm max-md:p-3" to="/about">
        About Us
      </Link>

      {customer.id && (
        <>
          <Link className="hover:text-neutral-500 max-lg:text-sm max-md:p-3" to="/profile">
            <div className="flex items-center">
      ...
      {!customer.id && (
        <>
          <Link className="text-amber-600 hover:text-amber-500 max-lg:text-sm max-md:p-4" to="/login">
            Login
          </Link>
          <Link className="text-amber-600 hover:text-amber-500 max-lg:text-sm max-md:p-4" to="/register">
            Register
          </Link>
        </>
      )}
